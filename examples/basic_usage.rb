...
window.include_feature(TextView::Position)  # Assuming Position is a module you want to include
...
screen.draw { |width, height| TextView::Draw.rectangle(1, 1, width / 2, height / 2, :white, :black) }
